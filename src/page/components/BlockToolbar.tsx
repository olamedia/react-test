...
export type BlockToolbarAction = BlockToolbarActionEnum.Edit |
...
export class BlockToolbar extends React.Component<BlockToolbarProps> {
    ...
    render() {
        ...
        return (
            <div {...attributes}>
                <button onClick={(...args) => this.triggerAction(BlockToolbarActionEnum.Edit, args)}>edit</button>

                <button onClick={(...args) => this.triggerAction(BlockToolbarActionEnum.Duplicate, args)}>duplicate
                </button>
                <button onClick={(...args) => this.triggerAction(BlockToolbarActionEnum.Delete, args)}>delete</button>
                <button onClick={(...args) => this.triggerAction(BlockToolbarActionEnum.Hide, args)}>hide</button>
            </div>
        )
    }
}
